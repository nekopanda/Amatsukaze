...
// static
void FileHashList::CalcHash(FastHashParam& p, LPWSTR filename, __int64 filesize, BYTE* hash)
{
...
void FileHashList::Benchmark(FastHashParam& p, LPWSTR filename, __int64 filesize)
{
...
size_t utf8toutf16(wchar_t* utf16, const BYTE* urf8, size_t utf8len)
{
	size_t utf16len = 0;
...
size_t utf16toutf8(BYTE* urf8, const wchar_t* utf16, size_t utf16len)
{
	size_t utf8len = 0;
...
std::unique_ptr<FileHashList::VirtualAllocMemory> FileHashList::AllocateBuffer(BYTE** ppBuffer, size_t* memSize, DWORD SectorSize, DWORD blocksize)
{
	if( PageSize == 0 ){
		SYSTEM_INFO info;
		GetSystemInfo(&info);
...
// static
void FileHashList::MakePath(wchar_t* path, const HashData& hd)
{
